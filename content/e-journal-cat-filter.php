...
<div class="table-responsive">
    <table class="table table-hover table-bordered">
        ...
        <?php
        $no     = $start+1;
        $sql    = mysql_query("SELECT * FROM e-journal WHERE jurusan='Teknik Informatika' AND (judul LIKE '%$search%' OR thn_terbit LIKE '%$search%') ORDER BY judul ASC LIMIT $start,$per_page");
        $jml    = mysql_num_rows($sql);
        if($jml >=1){
            while($data=mysql_fetch_array($sql)){
                $kd = $data['kd_jurnal'];
...
<div class="table-responsive">
    <table class="table table-hover table-bordered">
        ...
        <?php
        $no     = $start+1;
        $sql    = mysql_query("SELECT * FROM e-journal WHERE jurusan='Manajemen Informatika' AND (judul LIKE '%$search%' OR thn_terbit LIKE '%$search%') ORDER BY judul ASC LIMIT $start,$per_page");
        $jml    = mysql_num_rows($sql);
        if($jml >=1){
            while($data=mysql_fetch_array($sql)){
                $kd = $data['kd_jurnal'];
...
<div class="table-responsive">
    <table class="table table-hover table-bordered">
        ...
        <?php
        $no     = $start+1;
        $sql    = mysql_query("SELECT * FROM e-journal WHERE jurusan='Akuntansi' AND (judul LIKE '%$search%' OR thn_terbit LIKE '%$search%') ORDER BY judul ASC LIMIT $start,$per_page");
        $jml    = mysql_num_rows($sql);
        if($jml >=1){
            while($data=mysql_fetch_array($sql)){
                $kd = $data['kd_jurnal'];
...
<div class="table-responsive">
    <table class="table table-hover table-bordered">
        ...
        <?php
        $no     = $start+1;
        $sql    = mysql_query("SELECT * FROM e-journal WHERE jurusan='Manajemen' AND (judul LIKE '%$search%' OR thn_terbit LIKE '%$search%') ORDER BY judul ASC LIMIT $start,$per_page");
        $jml    = mysql_num_rows($sql);
        if($jml >=1){
            while($data=mysql_fetch_array($sql)){
                $kd = $data['kd_jurnal'];
...
<div class="table-responsive">
    <table class="table table-hover table-bordered">
        ...
        <?php
        $no     = $start+1;
        $sql    = mysql_query("SELECT * FROM e-journal WHERE jurusan='Sastra Inggris' AND (judul LIKE '%$search%' OR thn_terbit LIKE '%$search%') ORDER BY judul ASC LIMIT $start,$per_page");
        $jml    = mysql_num_rows($sql);
        if($jml >=1){
            while($data=mysql_fetch_array($sql)){
                $kd = $data['kd_jurnal'];
...
<div class="table-responsive">
    <table class="table table-hover table-bordered">
        ...
        <?php
        $no     = $start+1;
        $sql    = mysql_query("SELECT * FROM e-journal WHERE jurusan='Ilmu Komunikasi' AND (judul LIKE '%$search%' OR thn_terbit LIKE '%$search%') ORDER BY judul ASC LIMIT $start,$per_page");
        $jml    = mysql_num_rows($sql);
        if($jml >=1){
            while($data=mysql_fetch_array($sql)){
                $kd = $data['kd_jurnal'];
